...
- =state_config=  :: Using the state of the entities, define /cohorts/
...
(=model_type=), its hyperparameters (=model_parameters=), the features
...
information about the temporal setting of the features) and =n_examples=
...
**** ={test, train}_results.{test, train}_evaluations=
...
#+BEGIN_SRC sql
\d test_results.test_evaluations
#+END_SRC
...
****  ={test, train}_results.{test, train}_predictions=
...
**** TODO:  ={test, train}_results.{test, train}_results.feature_importances=

**** TODO:  ={test, train}_results.{test, train}_results.individual_importances=

**** TODO:  ={test, train}_results.{test, train}_results.list_predictions=
