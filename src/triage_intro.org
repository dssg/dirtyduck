...
=features.risks_aggregation_imputed=. This table will more Columns:
...
With this change =triage= will generate =20= new features.
...
So, we will end with =risks_entity_id_1month_risk_medium_sum= for example.
