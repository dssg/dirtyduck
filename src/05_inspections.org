...
#+BEGIN_SRC sql
select model_group_id, model_type, model_parameters from model_metadata.model_groups;
#+END_SRC
...
ma.lookback_duration as feature_lookback_duration,  ma.feature_start_time
from model_metadata.models as mo
join test_results.test_predictions as pr using (model_id)
...
num_positive_labels
from test_results.test_evaluations where model_id = 7
...
#+BEGIN_SRC sql
select model_group_id, model_type, model_parameters
