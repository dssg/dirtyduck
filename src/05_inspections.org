...
#+BEGIN_SRC yaml :tangle ../triage/experiment_config/inspections_dt.yaml :exports none
model_group_keys:
  - 'class_path'
  - 'parameters'
  - 'feature_names'
...
#+BEGIN_SRC yaml :tangle ../triage/experiment_config/inspections_label_failed_01.yaml :exports none
model_group_keys:
  - 'class_path'
  - 'parameters'
  - 'feature_names'
