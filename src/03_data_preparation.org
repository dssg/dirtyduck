...
| Canvass                  | 95,642                |
| License                  | 23,607                |
| Canvass Re-Inspection    | 18,775                |
| Complaint                | 16,780                |
| License Re-Inspection    | 8,347                 |
| Complaint Re-Inspection  | 6,867                 |
| Short Form Complaint     | 6,464                 |
...
| Pass                 | 102,278               |
| Fail                 | 34,975                |
| Pass w/ Conditions   | 20,672                |
| Out of Business      | 15,838                |
| No Entry             | 5,527                 |
| Not Ready            | 1,486                 |
...
#+BEGIN_SRC ipython :ipyfile ./images/inspections_over_time.png :results silent
...
#+BEGIN_SRC ipython :ipyfile ./images/facilities_inspected_over_time.png :results silent :exports results
df = pd.read_sql("""
select
date_trunc('month', date) as month,
...
#+BEGIN_SRC ipython :ipyfile ./images/facilities_with_inspections_failed_over_time.png :results silent
df = pd.read_sql(
    """
    select
    date_trunc('month', date) as month,
...
#+BEGIN_SRC ipython :ipyfile ./images/failed_inspections_over_time.png :results silent
df = pd.read_sql(
    """
    select
    date_trunc('month', date) as month,
...
#+BEGIN_SRC ipython :ipyfile ./images/failed_inspections_severe_violations_over_time.png :results silent
df = pd.read_sql(
    """
    select
    date_trunc('month', date) as month,
...
#+BEGIN_SRC ipython :ipyfile ./images/facilities_with_failed_inspections_severe_violations_over_time.png :results silent
df = pd.read_sql(
    """
    select
    date_trunc('month', date) as month,
