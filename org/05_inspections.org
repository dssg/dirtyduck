...
There are almost 40,000 entities in our database. Let’s assume that
these are all the facilities in Chicago.

What is the /probability distribution/ of facilities that are at *risk* of
...
Note that our data have bias: We only have data on facilities
...
facility was inspected ($I$), $P(V|I)$.

But the probability that we try to find is $P(V)$.


We will set this prediction task as a binary classification
...
|            4 | sklearn.tree.DecisionTreeClassifier     | {"max_depth": 2, "min_samples_split": 2}                                                   | {inspection,inspections,results,risks} | {10,16,22}  | {2015-12-01,2016-12-01,2017-12-01} | {" 0.445"," 0.392"," 0.342"} |
|            5 | sklearn.tree.DecisionTreeClassifier     | {"max_depth": 2, "min_samples_split": 5}                                                   | {inspection,inspections,results,risks} | {11,17,23}  | {2015-12-01,2016-12-01,2017-12-01} | {" 0.445"," 0.392"," 0.342"} |
|            6 | sklearn.tree.DecisionTreeClassifier     | {"max_depth": 10, "min_samples_split": 2}                                                  | {inspection,inspections,results,risks} | {12,18,24}  | {2015-12-01,2016-12-01,2017-12-01} | {" 0.337"," 0.325"," 0.347"} |
|            7 | sklearn.tree.DecisionTreeClassifier     | {"max_depth": 10, "min_samples_split": 5}                                                  | {inspection,inspections,results,risks} | {13,19,25}  | {2015-12-01,2016-12-01,2017-12-01} | {" 0.347"," 0.286"," 0.346"} |
|            8 | sklearn.tree.DecisionTreeClassifier     | {"max_depth": null, "min_samples_split": 2}                                                | {inspection,inspections,results,risks} | {14,20,26}  | {2015-12-01,2016-12-01,2017-12-01} | {" 0.343"," 0.328"," 0.274"} |
|            9 | sklearn.tree.DecisionTreeClassifier     | {"max_depth": null, "min_samples_split": 5}                                                | {inspection,inspections,results,risks} | {15,21,27}  | {2015-12-01,2016-12-01,2017-12-01} | {" 0.347"," 0.326"," 0.285"} |
|           10 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {inspection,inspections,results,risks} | {28,64,100} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.430"," 0.369"," 0.451"} |
|           11 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {inspection,inspections,results,risks} | {29,65,101} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.453"," 0.403"," 0.470"} |
|           12 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {inspection,inspections,results,risks} | {30,66,102} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.441"," 0.387"," 0.462"} |
|           13 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {inspection,inspections,results,risks} | {31,67,103} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.456"," 0.383"," 0.469"} |
|           14 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {inspections}                          | {32,68,104} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.342"," 0.310"," 0.285"} |
|           15 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {inspections}                          | {33,69,105} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.342"," 0.310"," 0.283"} |
|           16 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {inspections}                          | {34,70,106} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.342"," 0.310"," 0.297"} |
|           17 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {inspections}                          | {35,71,107} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.341"," 0.310"," 0.295"} |
|           18 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {results}                              | {36,72,108} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.359"," 0.330"," 0.389"} |
|           19 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {results}                              | {37,73,109} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.368"," 0.326"," 0.380"} |
|           20 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {results}                              | {38,74,110} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.390"," 0.361"," 0.395"} |
|           21 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {results}                              | {39,75,111} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.394"," 0.351"," 0.413"} |
|           22 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {risks}                                | {40,76,112} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.389"," 0.325"," 0.325"} |
|           23 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {risks}                                | {41,77,113} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.391"," 0.331"," 0.362"} |
|           24 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {risks}                                | {42,78,114} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.375"," 0.310"," 0.398"} |
|           25 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {risks}                                | {43,79,115} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.405"," 0.325"," 0.384"} |
|           26 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {inspection}                           | {44,80,116} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.394"," 0.334"," 0.351"} |
|           27 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {inspection}                           | {45,81,117} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.374"," 0.330"," 0.352"} |
|           28 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {inspection}                           | {46,82,118} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.405"," 0.327"," 0.367"} |
|           29 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {inspection}                           | {47,83,119} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.416"," 0.319"," 0.384"} |
|           30 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {inspection,results,risks}             | {48,84,120} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.446"," 0.380"," 0.441"} |
|           31 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {inspection,results,risks}             | {49,85,121} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.448"," 0.385"," 0.433"} |
|           32 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {inspection,results,risks}             | {50,86,122} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.440"," 0.394"," 0.483"} |
|           33 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {inspection,results,risks}             | {51,87,123} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.447"," 0.393"," 0.473"} |
|           34 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {inspection,inspections,risks}         | {52,88,124} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.391"," 0.342"," 0.348"} |
|           35 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {inspection,inspections,risks}         | {53,89,125} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.422"," 0.330"," 0.357"} |
|           36 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {inspection,inspections,risks}         | {54,90,126} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.411"," 0.341"," 0.365"} |
|           37 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {inspection,inspections,risks}         | {55,91,127} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.420"," 0.331"," 0.391"} |
|           38 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {inspection,inspections,results}       | {56,92,128} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.444"," 0.389"," 0.453"} |
|           39 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {inspection,inspections,results}       | {57,93,129} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.443"," 0.407"," 0.466"} |
|           40 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {inspection,inspections,results}       | {58,94,130} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.443"," 0.387"," 0.453"} |
|           41 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {inspection,inspections,results}       | {59,95,131} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.456"," 0.391"," 0.484"} |
|           42 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 2}  | {inspections,results,risks}            | {60,96,132} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.434"," 0.374"," 0.446"} |
|           43 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 2}  | {inspections,results,risks}            | {61,97,133} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.436"," 0.384"," 0.459"} |
|           44 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 100, "min_samples_split": 10} | {inspections,results,risks}            | {62,98,134} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.433"," 0.374"," 0.464"} |
|           45 | sklearn.ensemble.RandomForestClassifier | {"criterion": "gini", "max_features": "sqrt", "n_estimators": 250, "min_samples_split": 10} | {inspections,results,risks}            | {63,99,135} | {2015-12-01,2016-12-01,2017-12-01} | {" 0.451"," 0.384"," 0.484"} |
:END:
...
#+ATTR_HTML: :width 800 :height 800
#+ATTR_LATEX: :width 400 :height 300
[[file:images/sanjose-2.png][Imaginary example]]
...
If you look again at the [[file:~/projects/dsapp/dirtyduck/triage/inspection_audition_config.yaml][audition coonfiguration file]] you can filter
...
The plot [@fig:performance-next-time] show the /best/ model group selected by the strategies
...
- select the model groups (=41,45,32=) which have the best average precision@10% value or,
- select the best model group (=41,11,45=) using precision@10% today and use it for
...
groups selected by =audition=, using the /Postmodeling/ tool set, and then
...
#+RESULTS:
#+BEGIN_SRC org
kernel-3298cf53-13fc-4c05-81df-431f43a6e64a.json
#+END_SRC

#+BEGIN_SRC sh :dir /docker:root@tutorial_bastion:/root/.local/share/jupyter/runtime/
cat kernel-3298cf53-13fc-4c05-81df-431f43a6e64a.json
#+END_SRC
...
#+BEGIN_SRC org
{
  ...
  "hb_port": 56407,
  "ip": "0.0.0.0",
  "key": "4d957a1c-d3af8345cb72072e1644fe54",
  "transport": "tcp",
...
#+BEGIN_SRC jupyter-python :session /docker:root@tutorial_bastion:/root/conn.json
print("Hola")
#+END_SRC


#+BEGIN_SRC jupyter-python :session /docker:root@tutorial_bastion:/root/.local/share/jupyter/runtime/kernel-3298cf53-13fc-4c05-81df-431f43a6e64a.json
print("Hola")
#+END_SRC



#+BEGIN_SRC jupyter-python :session ~/docker-test-conn.json :results none
import matplotlib
matplotlib.use('Agg')
...
audition_output_path: '/triage/audition/inspections/results_model_group_ids.json'
...
the /labeled/ rows in $k$.

[fn:8] Think about it: we *can’t* learn the relationship between the
/features/ and the /label/ if we *ignore* the label.
