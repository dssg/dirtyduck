...
=audtion= will create the folloing  plots:

** Distance from best

[[file:~/projects/dsapp/dirtyduck/triage/images/distance_from_best_precision@10_pct.png]]

The way of read this image is:

** Model group performance over time


[[file:~/projects/dsapp/dirtyduck/triage/images/metric_over_time_precision@10_pct.png]]

** Metric "next time"


[[file:~/projects/dsapp/dirtyduck/triage/images/precision@10_pct_next_time.png]]

** "Regret"


[[file:~/projects/dsapp/dirtyduck/triage/images/regret_distance_from_best_rules_precision@10_pct.png]]


** "Regret" over time


[[file:~/projects/dsapp/dirtyduck/triage/images/regret_over_time_precision@10_pct.png]]


The final result of audition will be stored in a =json= file:

#+INCLUDE: "../triage/images/results_model_group_ids.json src json
...
# Postmodeling Configuration File
  ...
  audition_output_path: '/triage/images'
